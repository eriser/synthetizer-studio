...
private ModulePoolPanel poolPanel;
  ...
  {
    setBounds(e.getX() + getBounds().x - startingPosition_.x, e.getY() + getBounds().y - startingPosition_.y,
  ...
  public void mouseClicked(MouseEvent e)
  {
    ...
    {
      // Check if there are at least 1 input port to play with
      boolean hasFreeInputs = false;
      for (Port p : module_.getInputs())
      {
        if (!p.isLinked())
        {
