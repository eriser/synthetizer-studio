...
public class ModuleMixer extends BasicModule
{
  ...
  public ModuleMixer()
  {
    ...
    addInput(new BasicPort("iGain1", 50.0, Port.ValueType.CONTINUOUS, Port.ValueUnit.PERCENTAGE, new Port.ValueRange(0, 100),"Gain (volume) modifier for amplitude of sound wave 1"));
    // Input2 & his gain
    ...
    addInput(new BasicPort("iGain2", 50.0, Port.ValueType.CONTINUOUS, Port.ValueUnit.PERCENTAGE, new Port.ValueRange(0, 100),"Gain (volume) modifier for amplitude of sound wave 1"));
    // Input3 & his gain
    ...
    addInput(new BasicPort("iGain3", 50.0, Port.ValueType.CONTINUOUS, Port.ValueUnit.PERCENTAGE, new Port.ValueRange(0, 100),"Gain (volume) modifier for amplitude of sound wave 1"));
    // Input4 & his gain
    ...
    addInput(new BasicPort("iGain4", 50.0, Port.ValueType.CONTINUOUS, Port.ValueUnit.PERCENTAGE, new Port.ValueRange(0, 100),"Gain (volume) modifier for amplitude of sound wave 1"));
