...
public class MainWindow extends JFrame implements WindowListener
{
  ...
  private RegistryPresentation moduleRegistryPanel_;

  private PoolPresentation     modulePoolPanel_;

  private InformationPanel     informationPanel_;

  public MainWindow(RegistryPresentation registry, PoolPresentation pool)
  {
    super();
    moduleRegistryPanel_ = registry;
    modulePoolPanel_ = pool;
    setupMenuBar();
    setupPanels();
    setupGeneral();
  }
  ...
  private void setupPanels()
  {
    ...
    JSplitPane splitter2 = new JSplitPane(JSplitPane.VERTICAL_SPLIT, informationPanel_, (JPanel) modulePoolPanel_);
    ...
    JScrollPane scroll_ = new JScrollPane((JPanel) moduleRegistryPanel_);
  ...
  public RegistryPresentation getRegistryPanel()
  {
    return moduleRegistryPanel_;
  }

  public PoolPresentation getPoolPanel()
  {
